...
{
    self.state = BluetoothStateDisconnect;
    self.baseView.UVband.text = @"蓝牙就绪";
    self.button.title = @"搜索设备";
    NSLog(@"bluetooth is ready");
}

- (void) didDiscoverNewPeripheral
{
    [self.searchView.blueView reloadData];
    NSLog(@"discover new device");
}
